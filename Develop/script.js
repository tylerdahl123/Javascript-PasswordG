...
var length=""//undefined because the user fills in this array//they are not picking from a prerendered array. 
...
//now is the logic for the project. //i think i need to switch what gets concated//

if (userSymbols === true && userNumbers ===true  && userUpperCase ===true && userLowerCase === true); {
  storedPassword=storedPassword.concat(symbols,upperCase,lowerCase,numbers);
}
